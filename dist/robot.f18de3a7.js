    ...
    if (context.Pc[1] === 0 && match(func, cell_content) || context.Pc[1] !== 0) {
        if (typeof inst.func === 'function') {
            ...
            if (_stackJs.stack__is_empty(context.s)) {
                ...
                error_function("Program finished and this is the result of the execution of your program:");
...
function add_sentinel(Function, sentinel) {
    let lenght = Function.func.length;
    Function.func[lenght] = sentinel;
}
...
//# sourceMappingURL=robot.f18de3a7.js.map
